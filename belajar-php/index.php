    ...
    <body>
        ...
        <section id="box-profile">
            <div class="img-profile">
                <div class="photo" style="background-image: url(assets/img/p.jpg);"></div>
			</div>
            ...
            <div class="information">
                <div class="data">
                    ...
                    <p id="pAvailable" class="text-gray"><?php echo $availiability; ?></p>
                </div>
                <div class="data">
                    <p class="field">Age</p>
        ...
        <section id="input-form">
            <form method="POST"action="<?php echo $_SERVER['PHP_SELF'];?>">
                <div class="form">
                    <label>Id User</label>
                    <input id="inpIdUser" type="text" name="id" value="<?php echo $id;?>">
                </div>
                <div class="form">
                    <label>Name</label>
                    <input id="inpName" type="text" name="nama" value="<?php echo $nama;?>">
                </div>
                <div class="form">
                    <label>Role</label>
                ...
                <div class="form">
                    ...
                    <input id="inpAvailability" type="text" name="availability" value="<?php echo $availability;?>">
                </div>
                <div class="form">
                    <label>Age</label>
                ...
                <div class="form">
                    ...
                    <input id="inpYears" type="number" name="years_experience" value="<?php echo $experience;?>">
                </div>
                <div  class="form"> 
                    <label>Email</label>
                    <input id="inpEmail" type="email" name="email" value="<?php echo $email;?>">
                </div>
                <div class="form">
